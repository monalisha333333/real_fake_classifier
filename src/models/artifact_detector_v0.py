...
class ArtifactDetector(torch.nn.Module):
    def __init__(self, dim_artifact=512, radiuslow=40, radiushigh=120, num_classes=1):
        ...
        print("inside artefact detector: torch.nn.Linear(", dim_artifact,",", num_classes,")")
        # Normalization
    ...
    def forward(self, x, return_feat=False):
        middle_freq_image = self.fft_filter_module(x)
        feat = self.artifact_encoder(middle_freq_image)
