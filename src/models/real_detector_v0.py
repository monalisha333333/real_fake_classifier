...
from .artifact_detector_v0 import ArtifactDetector


# CO-SPY Detector
class RealDetector_v0(torch.nn.Module):
    def __init__(self, num_classes=1):
        ...
        print("in real_detector: torch.nn.Linear(",self.sem_dim + self.art_dim,",", num_classes,")")
